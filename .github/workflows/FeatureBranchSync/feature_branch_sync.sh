...
curl -X POST -H 'Content-type: application/json' --data '{ "blocks": [ { "type": "header", "text": { "type": "plain_text", "text": ":partywizard: Syncing Feature Branches [DONE]", "emoji": true } }, { "type": "section", "fields": [ { "type": "mrkdwn", "text": ":canvas-check: *clean merges:* '"$cleanMergeCount"'" }, { "type": "mrkdwn", "text": ":exclamation: *aborted merges:* '"$abortedMergeCount"'" }, { "type": "mrkdwn", "text": "'"$cleanBranchText"'" }, { "type": "mrkdwn", "text": "'"$abortedBranchText"'" } ] }, { "type": "section", "text": { "type": "mrkdwn", "text": ":x: *deletes:* '"$deletedBranchCount"'" } }, { "type": "section", "text": { "type": "mrkdwn", "text": "'"$deletedBranchText"'" } }, { "type": "section", "text": { "type": "mrkdwn", "text": "<!here|here>" } } ] }' https://hooks.slack.com/services/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
