...
npm list | grep prettier-plugin-apex || npm install --save-dev prettier-plugin-apex && npm install --save-dev --save-exact prettier-plugin-apex
...
code --install-extension salesforce.salesforcedx-vscode-expanded --force
