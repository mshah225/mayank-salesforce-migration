...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    <consoleConfig>
        ...
        <primaryTabColor>#990033</primaryTabColor>
    </consoleConfig>
    <defaultLandingTab>standard-home</defaultLandingTab>
    <description>App built for ASU Corporate Relations users</description>
    <isNavAutoTempTabsDisabled>false</isNavAutoTempTabsDisabled>
    <isNavPersonalizationDisabled>false</isNavPersonalizationDisabled>
    <isServiceCloudConsole>true</isServiceCloudConsole>
    <label>ASU Organizational Relationships</label>
    <logo>Administrator/ASU_logo_small.jpg</logo>
    <preferences>
    ...
    <tabs>New_Corporate_Relations_Contact</tabs>
    <workspaceConfig>
        <mappings>
