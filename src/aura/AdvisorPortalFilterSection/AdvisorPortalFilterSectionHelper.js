({
    ...
    applyFilters: function (component, toggleButtonFired) {
        ...
        let filterAction = component.get("c.filterContacts");
    ...
    validateDateFields: function (component) {
        ...
        if (!this.checkDateField(component, "PersistenceFromDate", "PersistenceToDate", "Persistence Change From Date")) {
            return false;
        }
    ...
    checkDateField: function(component, fromAttribute, toAttribute, fromDateErrorText) {
        if (component.get("v." + fromAttribute) && component.get("v." + toAttribute)
