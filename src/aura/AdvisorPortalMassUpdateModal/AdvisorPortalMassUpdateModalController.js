({
    ...
    updateDynamicFieldVisibility: function (component) {
        ...
        if (component.find("caseStatus") && component.find("caseStatus").get("v.value")) {
            ...
            if (component.find("caseStatus").get("v.value") === "Conferred with Student by Phone" ||
        ...
        if (component.find("studentIntent") && component.find("studentIntent").get("v.value")) {
            if (component.find("studentIntent").get("v.value") === "Not returning ever"        ||
        ...
        if (component.find("notReturning") && component.find("notReturning").get("v.value")
            && component.find("studentIntent") && component.find("studentIntent").get("v.value")) {
            if (component.find("notReturning").get("v.value").indexOf("Other") !== -1
