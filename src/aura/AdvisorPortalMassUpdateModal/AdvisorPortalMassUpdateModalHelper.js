({
    ...
    isFormValid: function (component) {
        ...
        if (component.get("v.RenderRequireReasonsAdministrativelyClosed")
        ...
        if (component.get("v.RequireRecommendedAction")
        ...
        if (component.get("v.RenderRequireRecommendedActionOther")
        ...
        if (component.get("v.RequireStudentIntent")
        ...
        if (component.get("v.RenderRequireNotReturning")
        ...
        if (component.get("v.RenderRequireNotReturningOther")
        ...
        if (component.get("v.RequireReturnTerm")
        ...
        if (component.get("v.RequireStudentRisk")
            && component.find("studentRisk")
            && !component.get("v.StudentRisk")) {
            component.find("studentRisk").showHelpMessageIfInvalid();
            isValid = false;
        }

        if (component.get("v.RenderRequireStudentRiskOther")
                        ...
                        if (component.find("recommendedActions").get("v.value")) {
                            for (let i = 0; i < component.find("recommendedActions").get("v.value").length; i++) {
                                ...
                                if (component.find("recommendedActions").get("v.value")[i]) {
                                    theCase.Recommended_Actions__c += component.find("recommendedActions").get("v.value")[i] + ";";
                                }
                            }

                            if (theCase.Recommended_Actions__c && theCase.Recommended_Actions__c.endsWith(";")) {
                                theCase.Recommended_Actions__c = theCase.Recommended_Actions__c.substr(0, theCase.Recommended_Actions__c.length - 1);
                            }
                        }
                        ...
                        if (component.find("notReturning")
                            ...
                            for (let i = 0; i < component.find("notReturning").get("v.value").length; i++) {
                                if (component.find("notReturning").get("v.value")[i]) {
                                    theCase.Reasons_Not_Returning__c += component.find("notReturning").get("v.value")[i] + ";";
                                }
                            }

                            if (theCase.Reasons_Not_Returning__c && theCase.Reasons_Not_Returning__c.endsWith(";")) {
                                theCase.Reasons_Not_Returning__c = theCase.Reasons_Not_Returning__c.substr(0, theCase.Reasons_Not_Returning__c.length - 1);
                            }
                        }
