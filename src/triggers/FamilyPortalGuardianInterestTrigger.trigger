trigger FamilyPortalGuardianInterestTrigger on Family_Portal_Guardian_Interest__c(
    after delete,
    after insert,
    after update,
    before delete,
    ...
    FamilyPortalInterestDispatcher dispatcher = new FamilyPortalInterestDispatcher(
        Trigger.new,
        Trigger.newMap,
        Trigger.old,
        Trigger.oldMap
